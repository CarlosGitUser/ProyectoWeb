...
<main>
			<div class="container-img">
				<img src="image/figu16.jpeg" alt="imagen-producto" />
			</div>
			<div class="container-info-product">
				<div class="container-price">
					<span>$885.00</span>
                    <span class="precio-tachado">$890.00</span>
				</div>
                ...
                <h3 class="nom-product">Gunpla Dragon Ball Z: Figure-Rise Standard Krillin Version 2 - Maqueta</h3>
                <br>
                    ...
                    <ul>
                       <li>La próxima serie estándar de aumento de figuras de Bandai es Son Goku y Krillin (se vende por separado).,</li>
                       <li>Construye los músculos de cada personaje utilizando el sistema de "acumulación muscular" de Bandai.</li>
                       <li>Combina la sorprendente expresión de Krillin con el anterior Android 18 de FRS para recrear su primera escena de beso como en el anime.</li>
                    </ul> 
					</div>
				</div>
                <br>
