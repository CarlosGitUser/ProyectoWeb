...
<main>
			<div class="container-img">
				<img src="image/figu8.jpg" alt="imagen-producto" />
			</div>
			<div class="container-info-product">
				<div class="container-price">
					<span>$1,287.00</span>
                    <span class="precio-tachado">$1,326.00</span>
				</div>
                ...
                <h3 class="nom-product">Banpresto Dragon Ball Legends Collab Super Saiyan Gogeta Figura</h3>
                <br>
                    ...
                    <ul>
                       <li>DRAGON BALL SUPER Figura de Banpresto!</li>
