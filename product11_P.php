...
<main>
			<div class="container-img">
				<img src="image/peli10.jpg" alt="imagen-producto" />
			</div>
			<div class="container-info-product">
				<div class="container-price">
					<span>$652.00</span>
                    <span class="precio-tachado">$656.00</span>
				</div>
                ...
                <h3 class="nom-product">Avatar : The Way Of Water [4K UHD + Blu-Ray]</h3>
                <br>
                    ...
                    Idioma  :  Inglés <br>
                    Dimensiones del paquete  :  17,25 x 13,69 x 1,4 cm; 303,91 g <br>
                    Número de modelo del producto  :  SH2804 <br>
                    Director  :  James Cameron <br>
                    Formato de medios  :  4K, NTSC, Subtitled <br>
                    Fecha de lanzamiento  :  20 junio 2023 <br>
                    Actores  :  Sam Worthington, Zoe Saldana, Sigourney Weaver, Stephen Lang, Kate Winslet <br>
                    Doblados:  :  Francés, Español <br>
                    Estudio  :  20TH CENTURY STUDIOS <br>
					</div>
				</div>
                <br>
                <br>
