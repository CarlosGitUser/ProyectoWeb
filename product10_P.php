...
<main>
			<div class="container-img">
				<img src="image/peli25.jpg" alt="imagen-producto" />
			</div>
			<div class="container-info-product">
				<div class="container-price">
					<span>$78.00</span>
                    <span class="precio-tachado">$85.00</span>
				</div>
                ...
                <h3 class="nom-product">Perdona Si Te Llamo Amor</h3>
                <br>
					...
					<div class="text-description">
                      Relación de aspecto  :  Unknown <br>
                      Producto descontinuado por el fabricante  :  No <br>
                      Idioma  :  Castellano <br>
                      Dimensiones del paquete  :  19 x 13,6 x 1 cm; 80 g <br>
                      Subtítulos:  :  None <br>
					</div>
				</div>
                <br>
