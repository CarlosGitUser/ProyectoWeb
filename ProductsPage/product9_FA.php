...
<main>
			<div class="container-img">
				<img src="image/figu21.jpg" alt="imagen-producto" />
			</div>
			<div class="container-info-product">
				<div class="container-price">
					<span>$1,648.00</span>
                    <span class="precio-tachado">$1,653.00</span>
				</div>
                ...
                <h3 class="nom-product">Demon Slayer - Giyu Tomioka Figura Popup Parade 17cm</h3>
                <br>
                    ...
                    <ul>
                       <li>Producto oficial de Banpresto/Little Buddy</li>
                       <li>Bonito y coleccionable</li>
